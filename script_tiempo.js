...
<img src="./galerias/memoriales/llancahue/llancahue_2004.webp" data-descripcion="Victor Eugenio Rudlof Reyes <br> 32 años, Obrero Maderero."onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    </div>
...
markerlasmarias.on('click', function() {
    ...
    if (anioSlider >= 2017.1) {
        ...
        contenido = `<h3>Ejecución Aerodromo las Marías</h3>
                     <div class="galeria">
                    <img src="./galerias/memoriales/lasmarias/chico-carreno-.webp" data-descripcion="Victor Hugo Carreño Zuñiga<br>
    ...
    if (anioSlider >= 2000) {
        ...
        openPanel(
            `<h3>Querella y Exhumación del Caso Chihuío</h3>
                                                          ...
                                                          <div class="galeria">
        <img src="./galerias/memoriales/chihuio/osamentas_chihuio.webp"data-descripcion="Exhumación en Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
     <img src="./galerias/memoriales/chihuio/osamentas_chihuio_2.webp"data-descripcion="Exhumación en Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
</div>
...
markerpichoy.on('click', function() {
    ...
    <img src="./galerias/memoriales/pichoy/pichoy_1.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/pichoy/pichoy_2.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/pichoy/pichoy_3.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
     <img src="./galerias/memoriales/pichoy/pichoy_4.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    </div>`;
...
markernanco.on('click', function() {
    ...
    if (anioSlider >= 2016) {
        contenido = `<h3>Memorial de Maiquillahue</h3>
         ...
         <img src="./galerias/memoriales/maiquillahue/maiquillahue_1.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
markerestancilla.on('click', function() {
  ...
  <img src="./galerias/memoriales/estancilla/romeria_estancilla.webp"data-descripcion="Juan José Boncompte Andreu <br> 31 años. economista y militante del mir" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
  </div>
...
markermano.on('click', function() {
    ...
    if (anioSlider >= 1997) {
        ...
        <img src="./galerias/memoriales/lamano/lamano_2.webp"data-descripcion="2004 Velatón en conmemoración de Juan José Boncompte Andreu" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        <img src="./galerias/memoriales/lamano/lamano_3.webp"data-descripcion="2004 Velatón en conmemoración de Juan José Boncompte Andreu" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
<img src="./galerias/memoriales/lamano/lamano_1.webp"data-descripcion="Juan José Boncompte Andreu <br> 31 años. economista y militante del mir" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        </div>
...
markersededario.on('click', function() {
    ...
    openPanel(
        ...
        <div class="galeria">
    <img src="./galerias/actividades/encuentro_nacional/encuentro_2004.webp"data-descripcion="Encuentro nacional en Sede Rubén Darío" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        </div>`,
        `<h3>Expedientes</h3>`
    );
});
...
markercni.on('click', function() {
    ...
    if (anioSlider >= 2013) {
        contenido = `<h3>Encuentro Nacional de la Agrupación 2013</h3>
               <div class="galeria">
<img src="./galerias/actividades/encuentro_2013/encuentro_2013.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
</div>
    `;
        anioTexto = '2013';
        ...
        <p>
               <div class="galeria">
<img src="./galerias/actividades/visita_ana/ana_1.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
  <img src="./galerias/actividades/visita_ana/ana_2.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
  <img src="./galerias/actividades/visita_ana/ana_3.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
markerguzman.on('click', function() {
    ...
    openPanel(`
        <h3> El Juez Guzman toma declaraciones en la región de los Ríos</h3>
                   ...
                   <div class="galeria">
                    <img src="./galerias/prensa/guzman_1.webp"data-descripcion="Sebastián Rodrigo Rivas Ovalle<br> 23 años, estudiante" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
markeruach.on('click', function() {
    ...
    openPanel(
        `<h3>Memorial Universidad Austral de Chile</h3>
         ...
         <img src="./galerias/memoriales/uach/cruz_uach.webp"data-descripcion="Primera cruz memorial UACH" onclick=" ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/memoriales/uach/Uach1.webp"data-descripcion="Primera cruz memorial UACH" onclick=" ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/memoriales/uach/uach-28.webp"data-descripcion="Primera cruz memorial UACH" onclick=" ampliarFoto(this.src, this.closest('.galeria'))">
    ...
    <img src="./galerias/memoriales/uach/VALENZUELA-SALAZAR-HECTOR-DARIO.webp"data-descripcion="Héctor Dario Valenzuela Salazar<br> 27 años, Profesor universitario" onclick=" ampliarFoto(this.src, this.closest('.galeria'))">
...
markercementerio.on('click', function() {
  ...
  <img src="./galerias/memoriales/cementerio/memorial_cementerio.webp"data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
  </div>
<p>
...
markermemoliquine.on('click', function() {
    ...
    if (anioSlider < 1995) {
        ...
        openPanel(
            ...
            <div class="galeria">
                <img src="./galerias/memoriales/liquine/Liquine_1992.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
            </div>
...
markermemoneltume.on('click', function() {
  ...
  <img src="./galerias/memoriales/neltume/neltume_1.webp" data-descripcion="" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        </div>
...
markerexhumacion.on('click', function() {
    ...
    openPanel(
         ...
         <div class="galeria">
        <img src="./galerias/memoriales/exhumacion/img066.webp"data-descripcion="Exhumación Jose Gregorio Liendo Vera" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/memoriales/exhumacion/img065.webp"data-descripcion="Exhumación Jose Gregorio Liendo Vera" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
markersolasierra.on('click', function() {
    ...
    openPanel(
         ...
         <div class="galeria">
        <img src="./galerias/actividades/solasierra/sola_sierra_1.webp"data-descripcion="Visita a la tumba de José Liendo Vera junto a Sola Sierra" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/actividades/solasierra/sola_sierra_2.webp"data-descripcion="Visita a la tumba de José Liendo Vera junto a Sola Sierra" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
</div>`,
        `<h3>Expedientes</h3>`
    );
});
...
markermemochihuio.on('click', function() {
    ...
    if (anioSlider >= 2006) {
        ...
        <img src="./galerias/memoriales/chihuio/chihuio_1.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        <img src="./galerias/memoriales/chihuio/chihuio_2.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        <img src="./galerias/memoriales/chihuio/chihuio_3.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        <img src="./galerias/memoriales/chihuio/chihuio_4.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        <img src="./galerias/memoriales/chihuio/chihuio_5.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/memoriales/chihuio/chihuio_6.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
          <img src="./galerias/memoriales/chihuio/chihuio_7.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
           <img src="./galerias/memoriales/chihuio/chihuio_8.webp"data-descripcion="Inauguración memoria de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
a la solidaridad de Jorge Gatica se concretó este trabajo
        ...
        <div class="galeria">
            <img src="./galerias/memoriales/chihuio/chihuio_2002.webp" data-descripcion="Primeros pasos para el memorial de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        </div>
        <p></p>`;
        ...
        contenido = `<h3>Primera piedra memorial de Chihuío</h3>
                                     <div class="galeria">
        <img src="./galerias/memoriales/chihuio/piedra_chihuio.webp"data-descripcion="Primera piedra del memorial de Chihuio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
</div>
...
markercddhh.on('click', function() {
 ...
 <div class="galeria">
         <img src="./galerias/actividades/cddhh/cddhh_1.webp"data-descripcion="Comisión nacional de derechos humanos se reune en la sede Laminadora" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         <img src="./galerias/actividades/cddhh/cdhh_2.webp"data-descripcion="Comisión nacional de derechos humanos se reune en la sede Laminadora" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        </div>`,
        `<h3>Expedientes</h3>`
    );
});
...
markerhuacho.on('click', function() {
    ...
    openPanel(
        `<h3>Memorial de Huachocopihue</h3>
                                     ...
                                     <div class="galeria">
                <img src="./galerias/memoriales/huachocopihue/memo_huachocopihue.webp"data-descripcion="Memorial Huachocopihue" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
 <img src="./galerias/memoriales/estancilla/barrientos_matamala_ral_jaime.webp"data-descripcion="Raúl Jaime Barrientos Matamala <br> 23 años, empleado y militante del mir" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
  <img src="./galerias/memoriales/llancahue/krauss-iturra-victor-fernando-scaled.webp"data-descripcion="Fernando Krauss Iturra <br> 24 años, Estudiante."  onclick="ampliarFoto(this.src, this.closest('.galeria'))">
            </div>
...
markersilla.on('click', function() {
    ...
    openPanel(
        `<h3>Memorial de la Silla</h3>
                                     ...
                                     <div class="galeria">
                <img src="./galerias/memoriales/silla/silla.webp"data-descripcion="Memorial de La Silla Liceo Armando Robles" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         </div>
...
markercodepu.on('click', function() {
    ...
    openPanel(
        ...
        <br>
                                    <div class="galeria">
                <img src="./galerias/actividades/codepu/afdd_codepu.webp"data-descripcion="Formalización de la Agrupación de Familiares de Detenidos Desaparecidos y Ejecutados Politicos en conjunto con el Comité de Defensa del Pueblo" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
         </div>" `,
        `<h3>Expedientes</h3>`
    );
});
